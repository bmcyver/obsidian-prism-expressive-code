 ...
 */
export type ExpressiveCodeHook<ContextType = ExpressiveCodeHookContext> = (
  context: ContextType,
) => void | Promise<void>;
...
export interface ExpressiveCodePluginHooks
  extends
    ...
    ExpressiveCodePluginHooks_Rendering {}
...
export async function runHooks<
  HookType extends keyof ExpressiveCodePluginHooks,
>(
  key: HookType,
  context: {
