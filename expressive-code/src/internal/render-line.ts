...
export function getRenderEmptyLineFn(
  context: ExpressiveCodeHookContextBase & {
    gutterElements: PluginGutterElement[];
  },
): RenderEmptyLineFn {
  return () => {
...
function validateAnnotationRenderOutput(
  nodes: Parents[],
...
export type PluginGutterElement = {
  pluginName: string;
  gutterElement: GutterElement;
};
