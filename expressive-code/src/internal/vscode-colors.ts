 ...
 */
export type VSCodeDefaultColorsByType =
  | [VSCodeDefaultColorDefinition, VSCodeDefaultColorDefinition]
  | VSCodeDefaultColorDefinition;
...
const defaultWorkbenchColors: {
  [key in VSCodeDefaultColorKey]: VSCodeDefaultColorsByType;
} = {
  // Base colors
...
export type VSCodeWorkbenchColors = {
  [key in VSCodeDefaultColorKey]: string;
} & { [key: string]: string };

export function resolveVSCodeWorkbenchColors(
  ...
  const colorsResolved = new Map<
    VSCodeDefaultColorsByType | string,
    string | null
  >();

  function applyColorTransform(
    unresolvedColor: VSCodeDefaultColorTransform,
  ...
  function resolveColor(
    unresolvedColor: VSCodeDefaultColorsByType | string,
  ): string | null {
 ...
 */
export function guessThemeTypeFromEditorColors(
  colors: { [key: string]: string } | undefined,
) {
